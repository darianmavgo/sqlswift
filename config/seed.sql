...
INSERT INTO identity(key,platform,value,description) VALUES
  ...
  ('version',             'all','1.1.0','Marketing version: CFBundleShortVersionString, `--version`, start-page footer'),
  ('build',               'all','2','CFBundleVersion / build metadata'),
  ...
  ('homepage',            'all','https://github.com/darianmavgo/sqlswift','About box, manifest, .desktop'),
